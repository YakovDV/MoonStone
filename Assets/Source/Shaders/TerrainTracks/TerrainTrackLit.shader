Shader "IncrementalMining/Project/TerrainTrackLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "TerrainTrackLitPasses.hlsl"
            ENDHLSL
        }
    ...
    Dependency "AddPassShader" = "Hidden/IncrementalMining/Project/TerrainTrackLit (Add Pass)"
